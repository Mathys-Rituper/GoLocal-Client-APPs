...
export default function ProductCard({product}){
    ...
    function RenderCard() {
        return (
            ...
            <span style={{fontFamily:"Lato", fontSize:"120%"}}>Undefined</span>

            <div style={{display:"flex", flexDirection:"row", justifyContent:"space-between"}}>
            <span style={{fontFamily:"Lato"}}>{new Intl.NumberFormat('de-DE', { style: 'currency', currency: 'EUR' }).format(price)}</span>
