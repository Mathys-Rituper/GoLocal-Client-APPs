...
export default function ProductCard({product, shopID, shopName, visibility}){
    ...
    function RenderCard() {
        return (
            <div onClick={() => {window.location.href=`https://localhost:3002/artisan/shop/item?shopID=${shopID}&shopName=${shopName}&visibility=${visibility}&item=${product.id}&itemName=${product.name}`}} style={{"width":"15rem", cursor:"pointer", margin:"1%", paddingBottom:"3%"}}>
