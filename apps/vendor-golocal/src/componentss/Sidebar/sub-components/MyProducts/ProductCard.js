...
export default function ProductCard({product, shopID}){
    ...
    function RenderCard() {
        return (
            <div onClick={() => {window.location.href=`https://localhost:3002/artisan/shop/product?shopID=${shopID}&product=${product.id}`}} style={{"width":"15rem", cursor:"pointer", margin:"1%", paddingBottom:"3%"}}>
