...
import placeHolder from "../../../../assets/placeHolderPackage.png"
...
export default function PackageCard({itemPackage, shopID, itemID, itemName, shopName}){
    ...
    function RenderCard() {
        return (
            <div onClick={() => {window.location.href=`https://localhost:3002/artisan/shop/item/package?shopID=${shopID}&shopName=${shopName}&item=${itemID}&itemName=${itemName}&packageID=${itemPackage.id}`}} style={{"width":"15rem", cursor:"pointer", margin:"1%", paddingBottom:"3%"}}>
