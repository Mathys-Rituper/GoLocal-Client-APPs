...
export default function ServiceCard({service, shopID}){
    ...
    function RenderCard() {
        return (
            <div onClick={() => {window.location.href=`https://localhost:3002/artisan/shop/service?shopID=${shopID}&service=${service.id}`}} style={{"width":"15rem", cursor:"pointer", margin:"1%", paddingBottom:"3%"}}>
