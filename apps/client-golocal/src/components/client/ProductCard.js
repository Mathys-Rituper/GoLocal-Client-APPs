    ...
    function RenderCard() {
        ...
        return (
            ...
            <div onClick={() => {window.location.href=`https://localhost:3001/shop/item?shopID=${shopID}&itemID=${id}`}}>
                <img style={{width:"100%",minHeight:"200px", border:"1px solid black"}} onError={(e) => e.target.src='https://www.primefaces.org/wp-content/uploads/2020/05/placeholder.png'} src={`data:image/jpeg;base64,${product.image}`} alt={name}/>
